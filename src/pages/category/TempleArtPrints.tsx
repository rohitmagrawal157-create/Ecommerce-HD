// src/pages/category/TempleArtPrints.tsx
...
const PER_PAGE = 12
const cfg      = CATEGORIES['temple-art-prints']
...
export default function TempleArtPrints() {
              ...
              <div className="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <details className="group">
                  ...
                  <div className="pb-4 grid gap-3">
                    {['Spiritual', 'Folk Art', 'Handpainted'].map(label => (
                ...
                <details className="group">
                  <summary className="flex items-center justify-between py-[15px] cursor-pointer select-none list-none">
                    <span className="text-[11.5px] font-semibold tracking-[0.18em] uppercase text-gray-500 dark:text-gray-400">Colour</span><Chevron />
                  </summary>
                  <div className="pb-3"><p className="text-[12px] text-gray-400">Select a colour to filter</p></div>
                </details>
                <details className="group">
                  <summary className="flex items-center justify-between py-[15px] cursor-pointer select-none list-none">
                    <span className="text-[11.5px] font-semibold tracking-[0.18em] uppercase text-gray-500 dark:text-gray-400">Materials</span><Chevron />
                  </summary>
                ...
                <details className="group">
                  <summary className="flex items-center justify-between py-[15px] cursor-pointer select-none list-none">
                    <span className="text-[11.5px] font-semibold tracking-[0.18em] uppercase text-gray-500 dark:text-gray-400">Shape</span><Chevron />
                  </summary>
                  <div className="pb-3"><p className="text-[12px] text-gray-400">Select a shape to filter</p></div>
                </details>
                <details className="group">
                  <summary className="flex items-center justify-between py-[15px] cursor-pointer select-none list-none">
                    <span className="text-[11.5px] font-semibold tracking-[0.18em] uppercase text-gray-500 dark:text-gray-400">Pattern</span><Chevron />
                  </summary>
                  <div className="pb-3"><p className="text-[12px] text-gray-400">Select a pattern to filter</p></div>
                </details>
                <details className="group">
                  <summary className="flex items-center justify-between py-[15px] cursor-pointer select-none list-none">
                    <span className="text-[11.5px] font-semibold tracking-[0.18em] uppercase text-gray-500 dark:text-gray-400">Occasions</span><Chevron />
                  </summary>
                  <div className="pb-3"><p className="text-[12px] text-gray-400">Select an occasion</p></div>
                </details>
                <details className="group">
                  <summary className="flex items-center justify-between py-[15px] cursor-pointer select-none list-none">
                    <span className="text-[11.5px] font-semibold tracking-[0.18em] uppercase text-gray-500 dark:text-gray-400">Feature</span><Chevron />
                  </summary>
