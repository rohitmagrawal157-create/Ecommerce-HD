// src/pages/category/BacklitLed.tsx
...
const ACCENT   = '#00C9FF'
const PER_PAGE = 12
const cfg      = CATEGORIES['backlit-led']

const Chevron = () => (
  <svg
    className="w-[13px] h-[13px] text-gray-400 group-open:rotate-180 transition-transform duration-200 flex-shrink-0"
...
export default function BacklitLed() {
...
>
  <div className="text-center w-full">
    ...
    <p className="text-white/60 text-sm md:text-base mt-3 max-w-xl mx-auto font-normal leading-relaxed">
      {cfg.description}
    </p>
    <ul className="flex items-center justify-center gap-[10px] text-base md:text-lg leading-none font-normal text-white mt-4 md:mt-5">
      ...
      <div className="s-py-100">
        {/*
          KEY FIX: pl-6 sm:pl-8 lg:pl-12 gives the LEFT breathing room from screen edge
          pr-4 sm:pr-6 lg:pr-8 on the right side
          This ensures sidebar never touches the screen edge
        */}
        <div className="w-full pl-6 sm:pl-8 lg:pl-10 pr-4 sm:pr-6 lg:pr-8">
          ...
          <div className="flex items-center justify-between mb-8 pb-4 border-b border-gray-200 dark:border-gray-700">
            ...
            {/* Left: result count — matches "531 Kitchen Results found" style */}
            <p className="text-[13px] text-gray-500 dark:text-gray-400">
              <strong className="text-gray-700 dark:text-white font-semibold">{filtered.length}</strong>
              {' '}Results found
            </p>
          ...
          <div className="flex items-start gap-10 xl:gap-14">
            ...
            {/* ══════════════════════════════════════
                SIDEBAR
                - Width 220px — not too wide
                - Labels: medium weight, proper size
                - Matches Image 2 reference exactly
                - py-[15px] per row — clean spacing
                - No outer border, only dividers
            ══════════════════════════════════════ */}
            <aside
              ...
              data-aos-delay="100"
            >
              {/* FILTERS heading — matches Image 2: medium size, not giant */}
              <h3 className="text-[12px]   uppercase text-red-300  mb-5">
                Filters
              </h3>
              ...
              <div className="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <details className="group">
                  <summary className="flex items-center justify-between py-[15px] cursor-pointer select-none list-none">
                    <span className="text-[11.5px] font-semibold tracking-[0.18em] uppercase text-gray-500 dark:text-gray-400">
                      Type
                    </span>
                    <Chevron />
                  </summary>
                  <div className="pb-4 grid gap-3">
                    {['Standard', 'RGB', 'Smart Home'].map(label => (
                ...
                <details className="group">
                  ...
                  <div className="pb-3">
                    <p className="text-[12px] text-gray-400">Select a colour to filter</p>
                  </div>
                </details>
                ...
                <details className="group">
                  ...
                  <div className="pb-3">
                    <p className="text-[12px] text-gray-400">Select a material to filter</p>
                  </div>
                </details>
                ...
                <details className="group">
                  ...
                  <div className="pb-3">
                    <p className="text-[12px] text-gray-400">Select a shape to filter</p>
                  </div>
                </details>
                ...
                <details className="group">
                  ...
                  <div className="pb-3">
                    <p className="text-[12px] text-gray-400">Select a pattern to filter</p>
                  </div>
                </details>
                ...
                <details className="group">
                  ...
                  <div className="pb-4 grid gap-3">
                    {['Canvas', 'Mirror', 'Shelf', 'Galaxy', 'Smart', 'Luxury'].map(label => (
                      <label key={label} className="categoryies-iteem flex items-center gap-[9px] cursor-pointer">
                ...
                <details className="group">
                  ...
                  <div className="pb-3">
                    <p className="text-[12px] text-gray-400">Select an occasion</p>
                  </div>
                </details>
                ...
                <details className="group">
                  ...
                  <div className="pb-3">
                    <p className="text-[12px] text-gray-400">Select a feature</p>
                  </div>
                </details>
              ...
              {totalPages > 1 && (
                <div className="mt-10 md:mt-12 flex items-center justify-center gap-[8px] flex-wrap">
                  <button
                    ...
                    disabled={page === 1}
                    className="text-title dark:text-white text-xl disabled:opacity-30 hover:opacity-70 transition-opacity px-1">
