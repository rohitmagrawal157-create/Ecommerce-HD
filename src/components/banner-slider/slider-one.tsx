...
export default function SliderOne() {
  return (
    ...
    >
      ...
      <SwiperSlide>
        <div className="relative w-full min-h-[460px] md:min-h-[500px] lg:min-h-[520px] overflow-hidden flex items-center"
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 h-full">
              ...
              <div className="lg:w-5/12 text-center lg:text-left">
                <div className="flex items-end justify-center lg:justify-start gap-2">
                  <span className="font-black text-[52px] md:text-[68px] lg:text-[80px] leading-none tracking-[-2px]"
                  ...
                  <img src={summerIcon} alt="Summer" className="w-[80px] md:w-[100px] lg:w-[120px] -mb-2" />
                </div>
                ...
                <div className="mt-6 flex flex-wrap gap-3 justify-center lg:justify-start">
                  ...
                  <Link to="/custom-canvas"
                    className="border-2 text-gray-900 font-semibold px-6 py-3 rounded-xl hover:text-white transition-all text-base group relative overflow-hidden"
              ...
              <div className="lg:w-7/12 flex justify-center">
                <div className="relative group max-w-[420px] w-full">
                  <img src={canvasImage1} alt="Premium Canvas Wall Art"
                    className="w-full h-auto rounded-2xl shadow-xl transition-transform duration-1000 group-hover:scale-[1.04]" />

                  <div className="absolute -top-5 -right-5 bg-white shadow-xl rounded-xl px-5 py-3 text-center z-20"
                    style={{ border: '2px solid transparent', boxShadow: '0 0 0 2px #5B4FBE33, 0 8px 24px rgba(91,79,190,0.15)' }}>
                    ...
                    <div className="text-xs text-gray-400 line-through">₹105</div>
                    <div className="text-[10px] font-semibold mt-0.5 tracking-wide"
                  ...
                  <div className="absolute -bottom-5 -right-5 text-white font-bold w-20 h-20 flex flex-col items-center justify-center rounded-full shadow-xl z-20"
                    style={{ background: 'linear-gradient(135deg,#5B4FBE,#E8314A,#F97316)' }}>
                    <span className="text-2xl">-15%</span>
                    <span className="text-[10px] tracking-[1px] mt-[-3px]">OFF</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 h-full">
              ...
              <div className="lg:w-5/12 text-center lg:text-left">
                ...
                <div className="mt-6 flex flex-wrap gap-3 justify-center lg:justify-start">
                  ...
                  <Link to="/gallery"
                    className="border-2 text-gray-900 font-semibold px-6 py-3 rounded-xl transition-all text-base group relative overflow-hidden"
              ...
              <div className="lg:w-7/12 flex justify-center">
                <div className="relative group max-w-[420px] w-full">
                  ...
                  <div className="absolute -top-5 -right-5 bg-white shadow-xl rounded-xl px-5 py-3 text-center z-20"
                    style={{ boxShadow: '0 0 0 2px #2563EB33, 0 8px 24px rgba(37,99,235,0.15)' }}>
                    <div className="text-2xl font-bold"
                    ...
                    <div className="text-xs text-gray-400 line-through">₹133</div>
                    <div className="text-[10px] font-semibold mt-0.5 tracking-wide"
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 h-full">
              ...
              <div className="lg:w-7/12 flex justify-center">
                <div className="relative group max-w-[420px] w-full">
                  ...
                  <div className="absolute -top-5 -right-5 bg-white shadow-xl rounded-xl px-5 py-3 text-center z-20"
                    style={{ boxShadow: '0 0 0 2px #E8314A33, 0 8px 24px rgba(232,49,74,0.15)' }}>
                    <div className="text-2xl font-bold"
                      style={{ background: 'linear-gradient(90deg,#E8314A,#F97316)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
                      ₹99
                    </div>
                    <div className="text-xs text-gray-400 line-through">₹124</div>
                    <div className="text-[10px] font-semibold mt-0.5 tracking-wide"
